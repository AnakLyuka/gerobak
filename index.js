...
fakethumb(buffer,'By Sword Botz')
fs.unlinkSync(ran)
})
break
case 'searchgrup':
...
Lexxy.sendMessage('6281584240439@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6281584240439@s.whatsapp.net', options, text, {quoted: flexx})
